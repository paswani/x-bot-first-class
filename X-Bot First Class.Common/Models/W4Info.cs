...
namespace X_Bot_First_Class.Common.Models
{
    ...
    public class W4Info
    {
        ...
        [Prompt("Please select your marriage status. If you are married, you might choose to withhold on the higher, Single status if you have other income. {||}", ChoiceFormat = "\n({0}) - {1}", ChoiceStyle=ChoiceStyleOptions.PerLine)]
        ...
        [Numeric(0,1000000)]
        [Prompt("Do you want to withhold and additional amount each paycheck? This might be useful if you have additional income outside of this position to avoid a year-end tax liability. If you want to withhold additionally, please simply enter the amount.")]
        [Optional]
        ...
        [Prompt("Do you think you are exempt from federal withholdings? Please answer 'yes' or 'no'. Generally, you are exempt if you did not have a federal tax liability last year and do not expect to have a tax liability this year.")]
